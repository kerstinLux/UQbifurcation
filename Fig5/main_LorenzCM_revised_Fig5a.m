...
syms x
aux = 0;
supp = [0,1]; % Change support here for Figure 5(b)
for k=0:N_trunc
...
set(gca,'FontSize',12);
% savefig(fig2,'histVsPDFapprox_LorenzRV_Uniform46_Gamma81_PolyApprox_chosenSupp01_N2_numMoms7.fig');
% saveas(fig2,'histVsPDFapprox_LorenzRV_Uniform46_Gamma81_PolyApprox_chosenSupp01_N2_numMoms7.eps','epsc');
